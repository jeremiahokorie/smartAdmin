import { LayoutPageModule } from './views/pages/layout-page/layout-page.module';
import { LayoutPageModule } from './../../.history/src/app/views/pages/layout-page/layout-page.module_20190908073411';
...
import { LayoutPageComponent } from '../app/views/pages/layout-page/layout-page.component';
...
@NgModule({
	declarations: [AppComponent, PagesComponent,LayoutPageModule,LayoutPageComponent],
	imports: [
