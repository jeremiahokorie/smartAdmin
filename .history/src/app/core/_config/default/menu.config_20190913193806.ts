	...
	public defaults: any = {
		...
		aside: {
			...
			items: [
				...
				{
					title: "My Profile", // <= Title of the page
				...
				{
					title: "Activity", // <= Title of the page
					desc: "Some my description goes here", // <= Description of the page
					root: true,
					page: "ecommerce/customers", // <= URL
					icon: "flaticon-line-graph" // <= Choose the icon
				},
				{
					title: "Layout", // <= Title of the page
					desc: "Some my description goes here", // <= Description of the page
					root: true,
					page: "ecommerce/products", // <= URL
					icon: "flaticon-line-graph" // <= Choose the icon
				}
