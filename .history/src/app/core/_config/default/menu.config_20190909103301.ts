	...
	public defaults: any = {
		...
		aside: {
			...
			items: [
				...
				{
					title: 'Activities', // <= Title of the user
					desc: 'Some my description goes here', // <= Description of the page
					root: true,
					page: 'activity', // <= URL
					icon: 'flaticon-line-graph' // <= Choose the icon
				...
				{
					title: 'Layout', // <= Title of the user
					desc: 'Some my description goes here', // <= Description of the page
					root: true,
				...
				{
					title: 'Analytics', // <= Title of the user
					desc: 'Some my description goes here', // <= Description of the page
					root: true,
					page: 'user-management/roles', // <= URL
					icon: 'flaticon-line-graph' // <= Choose the icon
				...
				{
					title: 'Check Out', // <= Title of the user
					desc: 'Some my description goes here', // <= Description of the page
					root: true,
					page: '/auth/login', // <= URL
					icon: 'flaticon-line-graph' // <= Choose the icon
