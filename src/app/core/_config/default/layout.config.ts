...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		'self': {
			...
			'logo': {
				'dark': './assets/media/logos/sc-logo-light.png',
				'light': './assets/media/logos/sc-logo-dark.png',
				'brand': './assets/media/logos/sc-logo-light.png',
				'green': './assets/media/logos/sc-logo-light.png',
			}
		},
		// == Portlet Plugin
		'portlet': {
